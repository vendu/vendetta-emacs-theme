...
(defun vendetta-init-c-stdc-font-lock-style()
  ...
  (font-lock-add-keywords 'c-mode
						  '(("\\<\\(__thread\\)\\>" 1 font-lock-thread-face)
							...
							("\\<\\(__\*__\\)\\>" 1 font-lock-attribute-face)))
...
(defun vendetta-init-c-zero-font-lock-style()
  (font-lock-add-keywords 'c-mode
						  '(("\\<\\(C_INLINE\\)\\>" 1 font-lock-function-face)
							("\\<\\(C_NOINLINE\\)\\>" 1 font-lock-function-face)
							("\\<\\(C_FASTCALL\\)\\>" 1 font-lock-function-face)
							("\\<\\(C_PURE\\)\\>" 1 font-lock-function-face)
							("\\<\\(C_CONST\\)\\>" 1 font-lock-constant-face)
							("\\<\\(C_NORETURN\\)\\>" 1 font-lock-function-face)
							...
							("\\<\\(C_ASMLINK\\)\\>" 1 font-lock-function-face)
